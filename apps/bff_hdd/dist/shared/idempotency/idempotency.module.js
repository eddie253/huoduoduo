...
const idempotency_guard_service_1 = require("./idempotency-guard.service");
...
exports.IdempotencyModule = IdempotencyModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [idempotency_guard_service_1.IdempotencyGuardService],
        exports: [idempotency_guard_service_1.IdempotencyGuardService]
    })
], IdempotencyModule);
