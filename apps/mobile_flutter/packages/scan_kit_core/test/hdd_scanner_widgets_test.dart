...
void main() {
  ...
  test('frame size presets increase width', () {
    const size = Size(390, 844);
    final compact = scanFrameRect(
      size,
      ScanFrameMode.twoDimensional,
      frameSize: ScanFrameSize.compact,
    );
    final medium = scanFrameRect(
      size,
      ScanFrameMode.twoDimensional,
      frameSize: ScanFrameSize.medium,
    );
    final large = scanFrameRect(
      size,
      ScanFrameMode.twoDimensional,
      frameSize: ScanFrameSize.large,
    );
