...
class SymbologyMapper {
  ...
  ScanSymbology fromZxingFormat(int? format) {
    switch (format) {
      case Format.codabar:
        return ScanSymbology.codabar;
      case Format.code39:
        return ScanSymbology.code39;
      case Format.code93:
        return ScanSymbology.code93;
      case Format.code128:
        return ScanSymbology.code128;
      case Format.itf:
        return ScanSymbology.itf;
      case Format.qrCode:
