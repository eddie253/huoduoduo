...
class AuthSession {
  ...
  factory AuthSession.fromJson(Map<String, dynamic> json) {
    return AuthSession(
      ...
      user: UserProfile.fromJson((json['user'] as Map?)?.cast<String, dynamic>() ?? <String, dynamic>{}),
      webviewBootstrap: WebviewBootstrap.fromJson(
        (json['webviewBootstrap'] as Map?)?.cast<String, dynamic>() ?? <String, dynamic>{}
      )
    );
  }
}
