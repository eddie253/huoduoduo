...
Doc ID: HDD-DOCS-ARCHIVE-ARCHITECTURE-IOS-PERMISSION-CHECKLIST
Version: v1.0
...
- [ ] AC-01: Governance header is complete
  - Command: Get-Content "docs/archive/architecture/IOS_PERMISSION_CHECKLIST.md" -Encoding UTF8 -TotalCount 40
