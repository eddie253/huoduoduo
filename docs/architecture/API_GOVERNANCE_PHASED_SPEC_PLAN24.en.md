...
CN/EN Pair Link: docs/architecture/API_GOVERNANCE_PHASED_SPEC_PLAN24.zh-TW.md
...
- [ ] AC-01: Governance header is complete
  - Command: Get-Content "docs/architecture/API_GOVERNANCE_PHASED_SPEC_PLAN24.en.md" -Encoding UTF8 -TotalCount 40
