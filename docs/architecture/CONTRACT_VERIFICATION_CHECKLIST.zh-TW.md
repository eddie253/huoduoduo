...
CN/EN Pair Link: docs/architecture/CONTRACT_VERIFICATION_CHECKLIST.en.md
...
- [ ] AC-01: Governance header is complete
  - Command: Get-Content "docs/architecture/CONTRACT_VERIFICATION_CHECKLIST.zh-TW.md" -Encoding UTF8 -TotalCount 40
